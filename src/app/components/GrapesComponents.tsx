...
export default function GrapesComponents() {
  ...
  useEffect(() => {
    ...
    <div id="irz7b" class="gjs-grid-row">
        ...
        <br/></div><a id="iqx3z1" class="gjs-button">Getting
        Started</a><a id="iar3s" class="gjs-button">Join Waitlist</a><img id="i3vvs" src="https://images.pexels.com/photos/7078666/pexels-photo-7078666.jpeg?auto=compress&cs=tinysrgb&w=800&dpr=2"/>
    </div>
  </div>
